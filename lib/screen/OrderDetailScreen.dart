...
import 'package:tazawad/screen/AttachmentScreens/attachment_screen.dart';
import 'package:tazawad/screen/DashRect.dart';
...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  init() async {
    print('==========ORDER DETAILS==========');
    log(widget.mOrderModel!.toJson());
    log(widget.mOrderModel!.lineItems!.length);
    widget.mOrderModel!.lineItems!.forEach((element) {
      element.metaData!.forEach((element2) {
        if (element2.key == "_woo_vou_codes") {
          log(element2.value);
        }
      });
    });
    // .metaData!.firstWhere((element) => element.key=="_woo_vou_codes"));
    mValue = mCancelList.first;
    fetchTrackingData();
    getTracking();
    if (widget.mOrderModel!.metaData != null) {
                ...
                return StatefulBuilder(
                  builder: (context, setState) {
                    return AlertDialog(
                      backgroundColor: Theme.of(context).cardTheme.color,
                      title: Text(
                          appLocalization.translate('title_cancel_order')!,
                          style: boldTextStyle()),
                      content: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  4.height,
                  Text(
                          appLocalization.translate('lbl_deliver_on')! +
                              " " +
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text(appLocalization.translate('lbl_tracking')!,
                    ...
                    .paddingAll(16)
                    .center(),
              ).paddingOnly(left: 16, bottom: 16, right: 16).visible(
                  mGetTrackingModel.isNotEmpty &&
                ...
                children: <Widget>[
                  ...
                  Center(
                    ...
                    onTap: () async {
                      ...
                      AttachmentScreen(
                        mOrderModel: widget.mOrderModel,
                        platform: platform,
                      ).launch(context);
                    },
                    child: Center(
                      child: Text(
                          appLocalization.translate('copon_view')! +
                              " (${widget.mOrderModel!.lineItems!.length})"

                          // appLocalization.translate('download_pdf_txt')!
                    ...
                    // , style: boldTextStyle(size: 16).copyWith(
                    //         color: Colors.green
                    //       )
            ...
            // .visible(widget.mOrderModel!.status == 'completed')
            ...
            Divider(
                    ...
                    color: Theme.of(context).textTheme.headlineMedium!.color)
                .visible(mOrderTrackingModel.isNotEmpty &&
                    widget.mOrderModel!.status == 'completed'),
            Container(
              margin: EdgeInsets.only(bottom: 8),
              padding: EdgeInsets.fromLTRB(16, 8, 16, 8),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      return GestureDetector(
                        onTap: () {
                          if (getIntAsync(PRODUCT_DETAIL_VARIANT,
                                  defaultValue: 1) ==
                              1) {
                            ProductDetailScreen1(
                                    mProId: widget
                                        .mOrderModel!.lineItems![0].productId)
                                .launch(context);
            ...
            Row(
              ...
              children: [
                Text(appLocalization.translate('lbl_Shipping')!,
                    style: secondaryTextStyle(size: 16)),
                Text(
                    widget.mOrderModel!.shippingTotal.toString().toInt() != 0
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(appLocalization.translate("lbl_total_order_price")!,
                    style: boldTextStyle()),
                PriceWidget(
