...
import 'package:tazawad/screen/membership/membership_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Widget mSideMenu(var text, var icon, Function onTap) {
      return SettingItemWidget(
        title: text,
        leading:
            Icon(icon, color: Theme.of(context).textTheme.titleSmall!.color),
            ...
            child: Column(
              ...
              children: [
                ...
                Divider(height: 4, thickness: 2, color: context.dividerColor)
                    ...
                    .visible(mIsLoggedIn),
                mSideMenu(
                    appLocalization.translate('lbl_guest_user'), Feather.user,
                    () async {
                ...
                Divider(height: 0)
                    ...
                    .visible(!mIsLoggedIn),
                mSideMenu(appLocalization.translate('lbl_orders'),
                    SimpleLineIcons.social_dropbox, () {
                ...
                Divider(height: 0)
                    ...
                    .visible(!mIsLoggedIn),
                mSideMenu(
                  appLocalization.translate('membership_plan')
                  // 'Memebership '
                  ,
                ...
                Divider(height: 0).paddingOnly(left: 16, right: 16).visible(
                    mIsLoggedIn &&
                        !getBoolAsync(IS_SOCIAL_LOGIN) &&
                        !getBoolAsync(IS_GUEST_USER)),
                ...
                Divider(height: 0)
                    ...
                    .visible(mIsLoggedIn && !getBoolAsync(IS_GUEST_USER)),
                mSideMenu(
                    appLocalization.translate('lbl_blog'), FontAwesome.list_alt,
                    () {
                  BlogListScreen().launch(context);
                }).visible(enableBlog == true && mIsLoggedIn),
                Divider(height: 0)
                    .paddingOnly(left: 16, right: 16)
                    .visible(enableTeraWallet == true),
                mSideMenu(appLocalization.translate('lbl_wallet')!,
                ...
                mSideMenu(
                    appLocalization
                        .translate('choose_product_detail_page_variant'),
                ...
                mSideMenu(appLocalization.translate('lbl_terms_conditions'),
                  ...
                  redirectUrl(getStringAsync(TERMS_AND_CONDITIONS).isEmptyOrNull
                      ? TERMS_CONDITION_URL
                ...
                SettingItemWidget(
                  ...
                  leading: Icon(Ionicons.language_sharp,
                      color: Theme.of(context).textTheme.titleSmall!.color),
                ...
                Divider(height: 0).paddingOnly(left: 16, right: 16),
                mSideMenu(
                    appLocalization.translate('btn_sign_out'), Feather.log_out,
                    () async {
                ...
                Divider(height: 0)
                    .paddingOnly(left: 16, right: 16)
                    .visible(mIsLoggedIn),
                mSideMenu(appLocalization.translate('lbl_sign_in'),
                    MaterialCommunityIcons.login, () {
                  SignInScreen().launch(context);
                }).visible(!mIsLoggedIn),
                Divider(height: 0)
                    .paddingOnly(left: 16, right: 16)
                    .visible(!mIsLoggedIn && enableMultiDemo == true),
                mSideMenu(appLocalization.translate('lbl_multiple_demo'),
