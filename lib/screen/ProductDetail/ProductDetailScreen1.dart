...
import 'package:tazawad/component/HomeScreenComponent/countdown_widget.dart';
...
log("LENGHT:"+appStore.userPlans.length.toString());
                                    log("PLAN IN ");
    ...
    final mCartData = productDetailNew != null
        ? GestureDetector(
            onTap: () {
              ...
              //  else if( appStore.userPlans.isEmpty){

              //                       toast(appLocalization!.translate("please_subscribe"));
                                     
              //                         MembershipPage().launch(context, pageRouteAnimation: PageRouteAnimation.Slide);
                ...
                productDetailNew!.inStock! == true
                    ? productDetailNew!.type! == 'external'
                        ...
                        : cartStore.isItemInCart(productDetailNew!.id.validate())
                            ? appLocalization!.translate('lbl_remove_cart')!.toUpperCase()
                            : appLocalization!.translate('lb_get_offer')!.toUpperCase()
                    : appLocalization!.translate('lbl_sold_out')!.toUpperCase(),
                textAlign: TextAlign.center,
