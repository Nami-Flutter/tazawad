...
class ProductResponse {
  ...
  ProductResponse(
      ...
      this.menuOrder,
      this.isAddedCart,
      this.isAddedWishList ,    this.metaData});
...
//    }
    ...
    if (json.containsKey('meta_data')) {
      log('CONTAINS META DATA');
       if ((json['meta_data'] as List ).isNotEmpty   ) {
      metaData = <MetaData>[];
      // metaData = (json['meta_data'] as List).map((e) => 
      // MetaData.fromJson(e)
      ...
      json['meta_data'].forEach((v) {
        ...
        log('HERE NO ERROR'+ '    ${metaData!.length}');
    }else {
      metaData = <MetaData>[];
    }
    }else {
...
//    }
    ...
    if (this.categories != null) {
     ...
     if (this.metaData != null && (this.metaData as List).length>0) {
