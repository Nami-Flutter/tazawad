...
import 'package:tazawad/screen/ChristmasScreens/HomeScreen5.dart';
import 'package:tazawad/screen/MyHomeScreen.dart';
...
abstract class AppStoreBase with Store {
 ...
 @observable
  List<MembershipModel> userPlans = [];
  ...
  void setNotification(bool val) {
    ...
    if (isMobile ) {
      // OneSignal.InAppMessages.paused(val);
    }
  }
}
